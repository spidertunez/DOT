...
class _RegisterScreenState extends State<RegisterScreen>
  ...
  Future<void> _register() async {
    ...
    final url = Uri.parse(
        'https://5087-197-35-242-200.ngrok-free.app/api/auth/register');
    ...
    try {
      final response = await http.post(
        ...
        body: jsonEncode({
          ...
          'userType': widget.userType, // ✅ استخدم اليوزر تايب
        }),
        headers: {
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  height: 250,
                  child: Image.asset("assets/loginAndSignup/signup.png"),
                ),
